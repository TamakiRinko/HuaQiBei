...
def createData():
    ...
    directory = "../基金列表及属性/"
    FundListPath = directory + "旧基金2.0_2.csv"
    ...
    List = AllData.loc[(AllData.基金类型 == "债券型") | (AllData.基金类型 == "货币型") | (AllData.基金类型 == "混合型")
                  | (AllData.基金类型 == "股票型") | (AllData.基金类型 == "股票指数") | (AllData.基金类型 == "债券指数")]
    List.to_csv(TradeInfoPath, encoding=Encoding)
    print("训练集生成完毕")
